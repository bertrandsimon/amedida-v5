...
export default function Title({ title1, title2, description, className = "" }) {
  ...
  return (
    <div
      className={`flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-6 lg:p-10 gap-4 sm:gap-6 ${className}`}
    >
